  ...
  useEffect(() => {
    const fetchInventoryItems = async () => {
      try {
        ...
        const res = await fetch(`https://virtual-finance-backend.onrender.com/api/inventory/items/${companyId}/`, {
          headers: {
  ...
  const handleSaveInvoice = async () => {
    ...
    try {
      ...
      const ledgerRes = await axios.post(
        `https://virtual-finance-backend.onrender.com/api/vouchers/ensure-sales-ledgers/${companyId}/`,
      ...
      const res = await axios.post(
        `https://virtual-finance-backend.onrender.com/api/vouchers/sales/${companyId}/create/`,
        payload,
        {
          headers: {
            'Content-Type': 'application/json',
