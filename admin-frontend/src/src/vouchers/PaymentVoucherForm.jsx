...
const PaymentVoucherForm = ({ onClose, companyId }) => {
  ...
  useEffect(() => {
    const fetchVoucherNumber = async () => {
      const res = await fetch(`https://virtual-finance-backend.onrender.com/api/vouchers/payment/next-number/?company_id=${companyId}`);
    ...
    const fetchSuppliers = async () => {
      ...
      const res = await fetch(`https://virtual-finance-backend.onrender.com/api/suppliers/${companyId}/`, {
